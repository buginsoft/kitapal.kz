                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="formItem <?php if($errors->has('fio')): ?> errorBox <?php endif; ?>">
                                            <input class="form-control" type="text" placeholder="<?php echo app('translator')->get('Profile.fio'); ?>" name="fio"
                                                   value="<?php echo e(isset($user)?$user->user_name:''); ?>" required>
                                            <?php $__errorArgs = ['fio'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="email" placeholder="Email" value="<?php echo e(isset($user)?$user->email:''); ?>" readonly="readonly">
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="formItem <?php if($errors->has('phone')): ?> errorBox <?php endif; ?>">
                                            <input class="form-control" type="text" name="phone" placeholder="<?php echo app('translator')->get('Profile.phone'); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <!----------------------------------------------------------------------------------------->
                            ...
                            <span id="pickup_addres">
                              <?php echo app('translator')->get('basket.address'); ?>
                            </span>
                        ...
                        <div class="border-right-b">
                            ...
                            <div class="bottom-itog">
                                ...
                                <p class="clearfix"><?php echo app('translator')->get('basket.total'); ?>
                                    <b class="pull-right">
                                        <span id="totalprice"><?php echo e(\Cart::session(session()->getId())->getTotal()); ?></span> <?php echo app('translator')->get('basket.tenge'); ?>
                                    </b>
                                </p>
                                <p id="promo_wrapper" class="clearfix" style="display: none"><?php echo app('translator')->get('basket.with_promo'); ?>
                                    <b class="pull-right">
                                        <span></span> <?php echo app('translator')->get('basket.tenge'); ?>
                                    </b>
                                </p>
                            </div>
                        </div>
        ...
        function checkpromo() {
            $.ajax({
                ...
                if (msq.success == 'true') {
                    ...
                    $("#promo_wrapper").children().children().html(<?php echo e(\Cart::session(session()->getId())->getTotal()); ?>* (100 - msq.percentage) / 100);
                } else {
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kitapal.kz/httpdocs/resources/views/checkout/nonregistred_checkout.blade.php ENDPATH**/ ?>