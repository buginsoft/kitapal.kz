                ...
                <tr>
                    <td align="center" style="padding-top: 30px;">
                        <?php if(app()->getLocale()=='kz'): ?>
                            ...
                            #<?php echo e($order_id); ?> – тапсырысыңыз қабылданды.<br>
                            Тапсырысыңызға рахмет!<br>
                        <?php else: ?>
                            Здравствуйте, <?php echo e($name); ?>!<br>
                            #<?php echo e($order_id); ?> – заказ принят.<br>
...
</html><?php /**PATH /var/www/vhosts/kitapal.kz/httpdocs/resources/views/mails/orderaccepted.blade.php ENDPATH**/ ?>