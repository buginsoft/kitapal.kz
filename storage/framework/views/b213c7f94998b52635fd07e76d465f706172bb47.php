            ...
            <div class="left-header">
                <form action="/search" method="get">
                    ...
                    <input class="search-top hidden-sm hidden-xs" type="text" name="search"
                           placeholder="<?php echo app('translator')->get('main.searchplaceholder'); ?>">
                </form>
            </div>
            <div class="right-header">
                <div class="lang-i hidden-sm hidden-xs">
                    <a <?php echo e(($lang=='ru')?'class=active':''); ?> href="<?php echo e(url('locale/ru')); ?>">рус</a>
                    <a <?php echo e(($lang=='kz')?'class=active':''); ?> href="<?php echo e(url('locale/kz')); ?>">қаз</a></div>
                <div class="icons-top">
                        ...
                        <div id="myModal" class="modal">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal__content contact_modal">
                                    <?php echo \DB::table('contact')->first()->contact2; ?>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=<?php echo e($contacts->phone); ?>"><i class="icons ic-whatsapp"></i></a>
                    <a href="mailto:<?php echo e($contacts->email); ?>"><i class="icons ic-message"></i></a>

                    <a href="/basket"><i class="icons ic-shops">
                            <span id="shoppingcart_count" class="ic-nof">
                                <?php if(auth()->guard()->check()): ?>
                                    <?php echo e(\Cart::session(\Auth::user()->user_id)->getTotalQuantity()); ?>

                                <?php else: ?>
                                    <?php echo e(\Cart::session(session()->getId())->getTotalQuantity()); ?>

                                <?php endif; ?>
                            </span></i></a>
                    <a href="<?php if(auth()->guard()->check()): ?> /profile <?php else: ?> /login <?php endif; ?>"><i class="icons ic-user"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container d-flex">
                <div class="navbar-header">
                    <div class="lang-i visible-xs visible-sm pull-right">
                        <a <?php echo e(($lang=='ru')?'class=active':''); ?> href="<?php echo e(url('locale/ru')); ?>">рус</a>
                        <a <?php echo e(($lang=='kz')?'class=active':''); ?> href="<?php echo e(url('locale/kz')); ?>">қаз</a>
                    </div>
                    <span class="dropdown navbar-brand">
                        <a class="dropdown dropdown-toggle" href="#" data-toggle="dropdown">
                            <i class="icons ic-menu"></i><?php echo app('translator')->get('main.menu'); ?>
                        </a>
                <ul class="dropdown-menu dropdownFull">
                  ...
                  <div class="visible-xs in-menu-li">
                   <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <li class="active">
                              <a href="/catalog/<?php echo e($item->genre_id); ?>">
                                  <?php echo e($item["genre_name_$lang"]); ?>
                    ...
                    <?php if($topMenu): ?>
                        <?php $__currentLoopData = $topMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><a href="<?php echo e($item['link']); ?>"><?php echo e($item['label']); ?></a></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $genresonsidemenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                    <a href="/catalog/<?php echo e($item->genre_id); ?>">
                                        <?php echo e((app()->getLocale()=='ru')?$item->genre_name_ru:$item->genre_name_kz); ?>
    ...
    <div class="modal-dialog">
        <div class="loginmodal-container">
            <div class="loginmodal-head">
                <h1><?php if($lang=='kz'): ?> Кері байланыс <?php else: ?> Обратная связь<?php endif; ?> </h1>
            ...
            <form id="contact" method="post" action="/sendMessage">
                ...
                <input id="fio" type="text" name="name" placeholder="<?php echo app('translator')->get('Profile.fio'); ?>"
                       value="<?php echo e((Auth::check())?\Auth::user()->user_name:''); ?>">
                <input id="email" type="text" name="email" placeholder="Email"
                       value="<?php echo e((Auth::check())?\Auth::user()->email:''); ?>">
                <input id="phone" type="text" name="phone" placeholder="<?php echo app('translator')->get('Profile.phone'); ?>"
                       value="<?php echo e((Auth::check())?\Auth::user()->phone:''); ?>">
                <textarea id="text" name="problem_text"
                          placeholder="<?php echo e((app()->getLocale()=='ru')?'Опишите вашу проблему...':'Мәселеңізді сипаттаңыз ...'); ?>"></textarea>
                <input type="submit" name="login" class="btn btn-border-blue login loginmodal-submit"
                       value="<?php echo app('translator')->get('main.send'); ?>">
            </form>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-6"><a href=""><img class="logo-footer" src="/img/logo/kitapal-logo-NEW-PNG.png"></a>
                <div class="row visible-xs">
                    <?php if($menuList): ?>
                        <?php $__currentLoopData = array_chunk($menuList,5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key4=>$menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xs-6">
                                <ul>
                                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key3=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e($item['link']); ?>"><?php echo e($item['label']); ?></a></li>
                                        <?php if($key4==1 && $key3==(count($menu)-1)): ?>
                                            <li><a href="#" data-toggle="modal" data-target="#login-modal">
                                                    <?php if($lang=='kz'): ?> Кері байланыс <?php else: ?> Обратная связь<?php endif; ?>
                                                </a></li>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                ...
                <p><?php echo app('translator')->get('main.internet_duken'); ?><span class="d-block"><?php echo app('translator')->get('main.copyright'); ?></span></p>
                <p><?php echo app('translator')->get('main.download_app_title'); ?></p>
                <div class="btn-mob">
            ...
            <div class="col-md-5 col-sm-6">
                <div class="row hidden-xs">
                    <?php if($menuList): ?>
                        <?php $__currentLoopData = array_chunk($menuList,5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xs-6">
                                <ul>
                                    <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a href="<?php echo e($item['link']); ?>"><?php echo e($item['label']); ?></a></li>
                                        <?php if($key==1 && $key2==(count($menu)-1)): ?>
                                            <li><a href="#" data-toggle="modal" data-target="#login-modal">
                                                    <?php if($lang=='kz'): ?> Кері байланыс <?php else: ?> Обратная связь<?php endif; ?>
                                                </a></li>
                                        <?php endif; ?>
        ...
        <div class="clearfix">
            <p class="pull-right bg-box">
                <?php echo e((app()->getLocale()=='ru')?'Разработка книжного интернет-магазина':'Кітап интернет-дүкенін әзірлеу'); ?>
...
<?php /**PATH /var/www/vhosts/kitapal.kz/httpdocs/resources/views/layouts/main.blade.php ENDPATH**/ ?>