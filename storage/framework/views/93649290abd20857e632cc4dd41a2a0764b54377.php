...
<?php $__env->startSection('content'); ?>
    <div class="page_500">
        <div class="container">
            <div class="section__body-500">
                <div class="section__body-block text-content">
                    <h2>500</h2>
                    <h4>Извините, произошла внутренняя проблема сервера </h4>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kitapal.kz/httpdocs/resources/views/errors/500.blade.php ENDPATH**/ ?>