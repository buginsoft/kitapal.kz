...
<head>
    ...
    <link rel="stylesheet" href="/reader/css/main.css?v=10">
    ...
    <script>
        ...
        function getcode(){
            $.ajax({
                ...
                window.reader = ePubReader( msg+"<?php echo e($last); ?>", {restore: true});
            });
        }
        document.onreadystatechange = function () {
            if (document.readyState === "complete") {
                <?php if(isset($type) && $type=='fragment'): ?>
                    window.reader = ePubReader("<?php echo e($book->fragment_path); ?>", {restore: true});
                <?php else: ?>
                getcode()
                <?php endif; ?>
            }
...
<?php /**PATH /var/www/vhosts/kitapal.kz/httpdocs/resources/views/readbook.blade.php ENDPATH**/ ?>