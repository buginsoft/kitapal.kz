                                ...
                                @foreach($recent_orders as $item)
                                    <tr>
                                        <td><div class="td-content customer-name">
                                                @if($item->user_id)
                                                    <img src="{{$item->user->avatar}}" alt="avatar">{{$item->user->user_name}}
                                                @else
                                                    {{$item->user_name.' '.$item->user_phone}}
                                                @endif
                                            </div>
                                        </td>
                                        <td><div class="td-content">{{'#'.$item->order_id}}</div></td>
                                        <td><div class="td-content">{{$item->updated_at->format('d/m/Y H:i')}}</div></td>
                                        <td><div class="td-content pricing"><span class="">{{$item->total.'тг'}}</span></div></td>
                                        <td><div class="td-content"><span class="badge @if($item->status->id==1) outline-badge-success @else outline-badge-primary @endif">{{$item->status->text}}</span></div></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content product-name">
                                                @if($item->main_image())
                                                    <img src="{{$item->main_image()->path}}" alt="product">{{$item->book_name}}
                                                @endif
                                            </div>
                                        </td>
                                        <td><div class="td-content"><span class="pricing">{{$item->paperbook_price.'тг'}}</span></div></td>
                                        <td><div class="td-content">{{$item->bought_count}}</div></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                                ...
                                @foreach($messages as $item)
                                    <div class="item-timeline timeline-primary">
                                        ...
                                        <div class="t-text">
                                            ...
                                            <p class="t-time">{{$item->created_at->format('d/m/Y H:i')}}</p>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
...
@section('js')
    ...
    <script>
        ...
        @foreach($category_text_ar as $item)
        category_labels.push('{{$item}}');
        @endforeach
