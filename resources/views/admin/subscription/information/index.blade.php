...
@section('table_title','Подписки описание')
@section('breadcrumb','Подписки описание')
    ...
    <table class="table table-bordered mb-4">
        ...
        @foreach ($list as $value)
            <tr>
                ...
                <td>{{ $value->title_kz }}</td>
                <td>{{ $value->sort }}</td>
                <td>
                    <form action="/admin/subscription-information/{{$value->id}}" method="post">
                        @csrf
                        @method('delete')
                ...
                <td>
                    <a class="btn btn-warning" href="/admin/subscription-information/{{$value->id}}/edit">Изменить</a>
                </td>
            </tr>
        @endforeach
        </tbody>
