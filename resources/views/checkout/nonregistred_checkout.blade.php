                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="formItem @if($errors->has('fio')) errorBox @endif">
                                            <input class="form-control" type="text" placeholder="@lang('Profile.fio')" name="fio"
                                                   value="{{isset($user)?$user->user_name:''}}" required>
                                            @error('fio')
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="email" placeholder="Email" value="{{isset($user)?$user->email:''}}" readonly="readonly">
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="formItem @if($errors->has('phone')) errorBox @endif">
                                            <input class="form-control" type="text" name="phone" placeholder="@lang('Profile.phone')"
                        ...
                        <div class="border-right-b">
                            ...
                            <div class="bottom-itog">
                                ...
                                <p class="clearfix">@lang('basket.total')
                                    <b class="pull-right">
                                        <span id="totalprice">{{\Cart::session(session()->getId())->getTotal()}}</span> @lang('basket.tenge')
                                    </b>
                                </p>
                                <p id="promo_wrapper" class="clearfix" style="display: none">@lang('basket.with_promo')
                                    <b class="pull-right">
                                        <span></span> @lang('basket.tenge')
                                    </b>
                                </p>
                            </div>
                        </div>
        ...
        function checkpromo() {
            $.ajax({
                ...
                if (msq.success == 'true') {
                    ...
                    $("#promo_wrapper").children().children().html({{\Cart::session(session()->getId())->getTotal()}}* (100 - msq.percentage) / 100);
                } else {
